            ...
            <div class="col-xs-12 col-md-4 ">
                ...
                <div class="contact-info">
                    <div class="footer-logo">
                            ...
                            <a href="index.php">
                                <img alt="logo" src="assets/images/logo.png" width="233" height="100"/>
                            </a>
                    ...
                    <p>
                        2319 W Olive ave, Burbank, 91505
                        California
                        1-888-blinds (1-888-892-9953)
                    </p>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="index.php">Search Blinds</a> - all rights reserved
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
